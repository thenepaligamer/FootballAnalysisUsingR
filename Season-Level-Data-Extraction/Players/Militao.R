...
militao <- fb_player_scouting_report("https://fbref.com/en/players/2784f898/Eder-Militao", pos_versus = "primary")

print(militao$Statistic)

footballer_selected <- militao[c(27,29,31,43,44, 47, 96, 87, 106, 102,108, 110, 122, 126, 149),]
...
#ggsave("militao-pizzachart.png", width = 3000, height = 3000, units = "px")
