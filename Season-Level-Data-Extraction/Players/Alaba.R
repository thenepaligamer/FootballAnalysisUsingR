...
alaba <- fb_player_scouting_report("https://fbref.com/en/players/05439de2/David-Alaba", pos_versus = "primary")

print(alaba$Statistic)

footballer_selected <- alaba[c(27,29,31,43,44, 47, 96, 87, 106, 102,108, 110, 122, 126, 149),]
...
#ggsave("alaba-pizzachart.png", width = 3000, height = 3000, units = "px")
